...
<table align="left" valign="top" border="0" width="615">
	<tr>
		...
		Intern >>Adressliste ersetzen		</span>
...
<br><br>		
		<?php
$target_path = "/home/www/web418/html/intern/file/Adressliste.xls";

 if (		($_FILES["uploadedfile"]["type"] == "excel/xls")
	|| 	($_FILES["uploadedfile"]["type"] == "excel/xlsx")
	|| 	($_FILES["uploadedfile"]["type"] == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" )
