...
<link rel="stylesheet" media="all and (max-device-width: 479px)" type="text/css" href="css/DE_Style_320_480Resolution.css">
<link rel="stylesheet" media="all and (min-device-width: 480px) and (max-device-width: 799px)" type="text/css" href="css/DE_Style_480_320Resolution.css">
<link rel="stylesheet" media="all and (min-device-width: 800px) and (max-device-width: 999px)" type="text/css" href="css/DE_Style_800_600Resolution.css">
<link rel="stylesheet" media="all and (min-device-width: 1000px) and (max-device-width: 1399px)" type="text/css" href="css/DE_Style_1024_768Resolution.css">
<link rel="stylesheet" media="all and (min-device-width: 1400px) and (max-device-width: 1799px)" type="text/css" href="css/DE_Style_1440_900Resolution.css">
<link rel="stylesheet" media="all and (min-device-width: 1800px)" type="text/css" href="css/DE_Style_1920_1000Resolution.css">
